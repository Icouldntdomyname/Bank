...
class GFG {
    public static void main(String[] args)
    {
        ...
        ThreadWithdrawal t1
            = new ThreadWithdrawal(obj, "Bryan", 20);
        ThreadWithdrawal t2
            = new ThreadWithdrawal(obj, "Yan", 30);
        ThreadDeposit t3
            = new ThreadDeposit(obj, "Yousong", 35);
        ThreadWithdrawal t4
            = new ThreadWithdrawal(obj, "Audrea", 10);
        ThreadDeposit t5
            = new ThreadDeposit(obj, "Bryan", 45);
